		...
		<>
			...
			<div className="mt-4 flex w-full flex-col gap-4 lg:flex-row lg:justify-between lg:space-y-0">
				{!isRunning ? (
					<Button
						...
						type="button"
						color="primary"
						className="w-auto lg:flex-1 text-foreground"
					>
				...
				<Button
					...
					variant="bordered"
					size="lg"
					className="w-auto lg:flex-1 dark:text-white text-foreground"
					type="button"
					color="danger"
			...
			<Dialog open={showResetDialog} onOpenChange={setShowResetDialog}>
				<DialogContent>
					...
					<DialogFooter>
						<Button variant="bordered" onPress={() => setShowResetDialog(false)}>
							Cancelar
						</Button>
						<Button
							onPress={() => {
