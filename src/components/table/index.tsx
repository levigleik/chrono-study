...
import { flattenObject, isDate } from './functions'
import { useTableSearch } from './hook'
...
const Table = <T extends Record<string, any>>({
  ...
  return (
    <TableComponent
      aria-label="Tabela"
      bottomContent={showPagination ? bottomContent : undefined}
      bottomContentPlacement="outside"
      classNames={{
        wrapper: 'max-h-[482px] p-0 shadow-none bg-card',
        th: 'bg-none  first:rounded-s-full last:rounded-e-full',
      }}
